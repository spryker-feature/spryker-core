...
- [GlueApplicationExtension ^1.15.0](https://github.com/spryker/glue-application-extension) (Extension)
...
- [OauthApi ^1.4.0](https://github.com/spryker/oauth-api) (Legacy Glue)
- [OauthBackendApi ^1.7.0](https://github.com/spryker/oauth-backend-api) (Legacy Glue)
...
- [SecurityBlockerRestApi ^1.1.0](https://github.com/spryker/security-blocker-rest-api) (Legacy Glue)
...
- [SessionRedisExtension ^1.2.0](https://github.com/spryker/session-redis-extension) (Extension)
...
- [Shop.StorageRouterExtension ^1.1.0](https://github.com/spryker-shop/storage-router-extension) (Extension)
...
- [StoresApi ^1.2.0](https://github.com/spryker/stores-api) (Glue Storefront)
- [StoresBackendApi ^1.0.0](https://github.com/spryker/stores-backend-api) (Glue Backend)
- [StoresRestApi ^1.5.0](https://github.com/spryker/stores-rest-api) (Legacy Glue)
- [SynchronizationExtension ^1.3.0](https://github.com/spryker/synchronization-extension) (Extension)
- [Touch ^4.9.0](https://github.com/spryker/touch) (Collector)
...
- [UrlsRestApi ^1.1.0](https://github.com/spryker/urls-rest-api) (Legacy Glue)
